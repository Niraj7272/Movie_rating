...
<!-- main body section -->
    <div class="main-content">
        ...
        <h3 class="main-title">Genre List</h3>
        <a href="add_type.php" class="add-admin-btn">Add Type</a>
        <div class="table-container">

        <?php
          $i = 1;
          $rows = mysqli_query($conn, "SELECT * FROM type");
        ...
        <tr>
            ...
            <td>
                <a href="type_delete.php?delete=<?php echo $row['type_id']?>" 
          ...
          endforeach; 
            ...
            echo"<div class='empty_text'>No Type Available</div>";
          }
          ?>
            </table>
        </div>
